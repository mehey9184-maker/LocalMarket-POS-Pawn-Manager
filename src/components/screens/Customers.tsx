...
export const Customers: React.FC = () => {
  ...
  const [mode, setMode] = useState<'list' | 'loans' | 'buys' | 'saps'>('list');
    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-[#121212]">
      ...
      <div className="px-8 py-6 bg-[#1A1A1A] border-b border-[#2A2A2A] space-y-6 shrink-0">
        ...
        <div className="flex items-center gap-6 overflow-x-auto no-scrollbar">
          {[
            { id: 'list', label: 'Verified Directory', icon: Users },
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <div className="p-8 border-b border-[#2A2A2A] bg-[#141414] shrink-0">
              <div className="relative max-w-xl">
                ...
                <input 
                  type="text" 
                  placeholder="Filter directory by name or RSA ID..." 
                  value={search}
                    ...
                    >
                      <div className="flex items-start justify-between mb-6">
                        ...
                        <div className="flex flex-col items-end">
                          <span className="px-2 py-0.5 rounded bg-emerald-950 text-emerald-400 text-[9px] font-black uppercase border border-emerald-800/30">Verified</span>
                          <span className="text-[10px] text-gray-600 font-mono mt-2">ID: {customer.idType}</span>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-6">
                        ...
                        <div className="p-3 bg-[#121212] rounded-2xl border border-[#2A2A2A]">
                          <span className="text-[9px] text-gray-500 font-black uppercase tracking-widest block mb-1">Total Spent</span>
                          <div className="flex items-center gap-2">

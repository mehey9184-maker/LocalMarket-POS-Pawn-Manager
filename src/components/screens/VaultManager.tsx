    ...
    <div className="flex-1 flex flex-col h-full bg-[#121212] p-3.5 sm:p-5 gap-4 relative overflow-hidden">
      ...
      <div className="bg-[#1E1E1E] rounded-xl p-3 border border-[#2A2A2A] flex flex-col sm:flex-row items-center justify-between gap-3 shadow-sm shrink-0">
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <button type="button" onClick={() => setActiveTab('overdue')} className={`px-3.5 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 transition flex-1 sm:flex-initial justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C85A32] focus-visible:ring-offset-2 ${activeTab === 'overdue' ? 'bg-[#C85A32] text-white' : 'bg-[#141414] text-gray-400 hover:text-gray-200 border border-[#2A2A2A]'}`}>
          ...
          <button type="button" onClick={() => setActiveTab('storage')} className={`px-3.5 py-2 rounded-lg text-xs font-semibold flex items-center gap-2 transition flex-1 sm:flex-initial justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C85A32] focus-visible:ring-offset-2 ${activeTab === 'storage' ? 'bg-[#C85A32] text-white' : 'bg-[#141414] text-gray-400 hover:text-gray-200 border border-[#2A2A2A]'}`}>
